---
title: "Download_Sequences_&_SNP_calling_dDocent"
author: "Matias Gomez"
date: "7/08/2019"
output: md_document
---
## Reanalysis of Dziedzic et al. (2019) O. faveolata data (https://www.ncbi.nlm.nih.gov//bioproject/PRJNA413258)
...
## NCBI link to this BioProject https://www.ncbi.nlm.nih.gov/biosample?LinkName=bioproject_biosample_all&from_uid=397196
...
## List of samples and SRA available here: https://www.ncbi.nlm.nih.gov/sra

#Sample 43 does not have a SRA link 
#Sample 42 does not have a SRA link
#Sample 41 does not have a SRA link
...
## Now we need to copy our geneome reference to run dDocent pipeline or you can download it from ftp://ftp.ncbi.nlm.nih.gov/sra/wgs_aux/MZ/GG/MZGG01/MZGG01.1.fsa_nt.gz
...
## Running dDocent on demultiplex files Dziedzic_2019_Data
```{bash eval = FALSE} 
dDocent
dDocent 2.7.7 
...
dDocent has finished with an analysis in /RAID_STORAGE2/mgomez/Orbicella_Raw/Dziedzic_2019_Data 
